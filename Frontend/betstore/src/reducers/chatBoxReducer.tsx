...
export const accountInfoReducer: React.Reducer<
  ChatAccountInfo,
  ChatActionType<any>
...
export const conversationControlReducer: React.Reducer<
  ConversationControl,
  ChatActionType<any>
...
export const messageControlReducer: React.Reducer<
  MessageControl,
  ChatActionType<any>
...
export const viewControlReducer: React.Reducer<
  ChatViewControl,
  ChatActionType<any>
> = (
