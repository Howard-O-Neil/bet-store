...
export const getsliderReducer: Reducer<StateType<DataSlider[]>, ActionType<any>> = (state = init, action) => {
	switch (action.type) {
		case GET_SLIDER:
...
export const addsliderReducer: Reducer<StateType<string>, ActionType<any>> = (state = {Error:"",IsFetching:false,Payload:""}, action) => {
	switch (action.type) {
		case ADD_SLIDER:
