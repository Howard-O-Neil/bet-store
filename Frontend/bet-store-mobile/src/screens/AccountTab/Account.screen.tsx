...
import { Image, StyleSheet, TouchableOpacity, FlatList, ScrollView, Button } from 'react-native';
    ...
    <View style={{ backgroundColor: 'transparent', flex: 1 }} >
      {
        account.Payload.IsLogin ?
            ...
            <TouchableOpacity activeOpacity={.8} style={{ flex: 0 }} onPress={() => navigation.navigate("Profile")}>
              <View style={styles.HeaderProfile}>
                ...
                <View style={styles.IconTitleContainer}>
                  <Ionicons style={styles.IconTitle} name="chevron-forward-outline"></Ionicons>
                </View>
              </View>
            </TouchableOpacity>
                ...
                renderItem={
                  ({ item }) =>
                    ...
                    <TouchableOpacity style={{ flexDirection: 'row', borderColor: '#ecf0f1', borderWidth: 1 }} onPress={() => HandleBTN(item.typeBtn)}>
                      ...
                      <View style={styles.IconTitleContainer}>
                        <Ionicons style={styles.IconItemList} name="chevron-forward-outline"></Ionicons>
                      </View>
                    </TouchableOpacity>
                }
              />
          ...
          <View style={{ justifyContent: 'center', alignItems: 'center', flex: 1 }}>
            <Text>
              Để sử dụng bạn cần đăng nhập vào tài khoản
        </Text>
            <TouchableOpacity activeOpacity={.8} style={styles.BtnAction} onPress={() => navigation.navigate("Login")}>
              <Text style={{ fontSize: 20, fontWeight: '600', color: 'white' }}>Đăng nhập</Text>
            </TouchableOpacity>
            <TouchableOpacity activeOpacity={.8} style={styles.BtnAction} onPress={() => navigation.navigate("Signup")}>
              <Text style={{ fontSize: 20, fontWeight: '600', color: 'white' }}>Đăng ký</Text>
            </TouchableOpacity>
          </View>
      }
